...
export default function RespostaErrada1Page2Hist1() {
            ...
            >
                ...
                <View style={styles.contText2}>
                    <Text style={styles.bodyText4}>
                        <Text style={{textAlign: 'center', fontSize: 19}}>Um brinquedo pode até ser útil para passar o tempo na recepção, mas não é o que Lilli deve levar então a resposta B não é a melhor opção.</Text>
                    </Text>
                </View>

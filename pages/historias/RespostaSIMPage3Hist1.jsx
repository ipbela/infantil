...
export default function RespostaSIMPage3Hist1() {
            ...
            >
                ...
                <View style={styles.contText2}>
                    <Text style={styles.bodyText4}>
                        <Text style={{textAlign: 'center', fontSize: 20}}>Segurando o espelhinho, Bella vai ver que não há nada de assustador e que é até divertido ver os próprios dentes.</Text>
                    </Text>
                </View>

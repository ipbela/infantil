...
export default function RespostaSIMPage4Hist1() {
            ...
            >
                ...
                <View style={styles.contText2}>
                    <Text style={styles.bodyText4}>
                        <Text style={{textAlign: 'center', fontSize: 32}}>É o Som do Sugador!</Text>
                    </Text>
                </View>
                ...
                <View style={styles.contText3}>
                    ...
                    <Pressable style={styles.btn_opcao} onPress={() => navigation.navigate("Pag4Hist1")}>
